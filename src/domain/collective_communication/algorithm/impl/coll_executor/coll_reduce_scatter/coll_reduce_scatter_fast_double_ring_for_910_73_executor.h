...
#ifndef COLL_REDUCESCATTER_FAST_DOUBLE_RING_FOR_910_73_EXECUTOR_H
#define COLL_REDUCESCATTER_FAST_DOUBLE_RING_FOR_910_73_EXECUTOR_H
#include "coll_reduce_scatter_ring_for_910_73_executor.h"

namespace hccl {
class CollReduceScatterFastDoubleRingFor91073Executor : public CollReduceScatterRingFor91073Executor {
public:
    explicit CollReduceScatterFastDoubleRingFor91073Executor(
        const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollReduceScatterFastDoubleRingFor91073Executor() = default;
