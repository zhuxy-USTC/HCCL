...
#ifndef COLL_REDUCESCATTER_RING_FOR_910_73_EXECUTOR_H
#define COLL_REDUCESCATTER_RING_FOR_910_73_EXECUTOR_H
#include "coll_reduce_scatter_executor.h"

namespace hccl {
class CollReduceScatterRingFor91073Executor : public CollReduceScatterExecutor {
public:
    explicit CollReduceScatterRingFor91073Executor(const HcclDispatcher dispatcher,
    std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollReduceScatterRingFor91073Executor() = default;
