...
#ifndef COLL_SCATTER_RING_FOR_910_73_EXECUTOR_H
#define COLL_SCATTER_RING_FOR_910_73_EXECUTOR_H
#include "coll_scatter_executor.h"

namespace hccl {
class CollScatterRingFor91073Executor : public CollScatterExecutor {
public:
    explicit CollScatterRingFor91073Executor(const HcclDispatcher dispatcher,
                                std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollScatterRingFor91073Executor() = default;
