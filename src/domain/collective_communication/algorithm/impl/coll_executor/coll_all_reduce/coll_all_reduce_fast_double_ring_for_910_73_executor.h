...
#ifndef COLL_ALL_REDUCE_FAST_DOUBLE_RING_FOR_910_73_EXECUTOR_H
#define COLL_ALL_REDUCE_FAST_DOUBLE_RING_FOR_910_73_EXECUTOR_H

#include "coll_all_reduce_double_ring_executor.h"

namespace hccl {
class CollAllReduceFastDoubleRingFor91073Executor : public CollAllReduceDoubleRingExecutor {

public:
    CollAllReduceFastDoubleRingFor91073Executor(
        const HcclDispatcher dispatcher, std::unique_ptr<TopoMatcher> &topoMatcher);
    ~CollAllReduceFastDoubleRingFor91073Executor() = default;
